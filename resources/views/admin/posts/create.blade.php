...
@section('main')
    ...
    <div class="page-breadcrumb d-flex flex-column flex-sm-row align-items-sm-center justify-content-between mb-4">
        <div>
            <h3 class="fw-bold text-primary mb-1">Create Post</h3>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-muted small mb-0">
                                Add title, category and featured image.
                            </p>
                        </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-muted small mb-0">
                                Write content and choose publish status.
                            </p>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control rounded-3 @error('content') is-invalid @enderror" id="content" name="content"
                                rows="12" placeholder="Write your post content here...">{{ old('content') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex gap-4">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="is_published_yes">
                                        Public
                                    </label>
                                </div>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="is_published_no">
                                        Draft
                                    </label>
                                </div>
