...
@section('main')
    {{-- Breadcrumb --}}
    <x-admin.breadcrumb title="Create Category" shortDescription="Add a new category for organizing posts."
                    ...
                    <x-admin.form route="admin.category.store" method="POST">
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="form-control rounded-3 @error('description') is-invalid @enderror" id="description" name="description"
                                rows="5" placeholder="Brief description of this category...">{{ old('description') }}</textarea>
